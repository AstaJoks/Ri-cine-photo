...
## User Experience
  ...
  ### Site Owner's Goals
  - To be able to view the website on different device sizes.
  - To ensure that the visitor can easily navigate through the site.
  - To show visitor the photography portfolio. 
  - To make sure that visitor could easily contact the photographer through get in touch form/social media. 
    
  ### Users Goals
  - To be able to navigate around the website with ease to find any information.
  - To be able to see the photographer's previous work and his portfolio.
  - To be able to find the photographer's social  media links for more updates and recent photography events.
  - to be able to contact the photographer for bookings, pricing or any general enquiries.
